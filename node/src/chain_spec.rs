...
fn mk_genesis(
    ...
    GenesisConfig {
		frame_system: Some(datahighway_runtime::SystemConfig {
			code: datahighway_runtime::WASM_BINARY
        ...
        parachain_info: Some(datahighway_runtime::ParachainInfoConfig  { parachain_id }),
    }
}
...
fn testnet_genesis(
    ...
    GenesisConfig {
        ...
        pallet_treasury: Some(Default::default()),
		parachain_info: Some(datahighway_runtime::ParachainInfoConfig { parachain_id: id }),
    }
}
...
fn dev_genesis(
	...
	datahighway_runtime::GenesisConfig {
        ...
        //     ..Default::default()
        // }),
		pallet_sudo: Some(datahighway_runtime::SudoConfig { key: root_key.clone() }),
        // pallet_babe: Some(BabeConfig {
        //     authorities: vec![],
        // }),
        // pallet_grandpa: Some(GrandpaConfig {
