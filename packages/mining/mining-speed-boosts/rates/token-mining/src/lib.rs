...
decl_storage! {
    trait Store for Module<T: Trait> as MiningSpeedBoostRatesTokenMining {
        ...
        pub MiningSpeedBoostRatesTokenMinings get(fn mining_speed_boosts_rates_token_mining): map T::MiningSpeedBoostRatesTokenMiningIndex => Option<MiningSpeedBoostRatesTokenMining>;
        ...
        pub MiningSpeedBoostRatesTokenMiningOwners get(fn mining_speed_boosts_rates_token_mining_owner): map T::MiningSpeedBoostRatesTokenMiningIndex => Option<T::AccountId>;

        /// Stores mining_speed_boosts_rates_token_mining_rates_config
        pub MiningSpeedBoostRatesTokenMiningRatesConfigs get(fn mining_speed_boosts_rates_token_mining_rates_configs): map T::MiningSpeedBoostRatesTokenMiningIndex =>
