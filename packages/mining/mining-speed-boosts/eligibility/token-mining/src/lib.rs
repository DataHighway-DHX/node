...
decl_storage! {
    trait Store for Module<T: Trait> as MiningSpeedBoostEligibilityTokenMining {
        ...
        pub MiningSpeedBoostEligibilityTokenMinings get(fn mining_speed_boosts_eligibility_token_mining): map T::MiningSpeedBoostEligibilityTokenMiningIndex => Option<MiningSpeedBoostEligibilityTokenMining>;
        ...
        pub MiningSpeedBoostEligibilityTokenMiningOwners get(fn mining_speed_boosts_eligibility_token_mining_owner): map T::MiningSpeedBoostEligibilityTokenMiningIndex => Option<T::AccountId>;

        /// Stores mining_speed_boosts_eligibility_token_mining_result
        pub MiningSpeedBoostEligibilityTokenMiningEligibilityResults get(fn mining_speed_boosts_eligibility_token_mining_eligibility_results): map (T::MiningSpeedBoostConfigurationTokenMiningIndex, T::MiningSpeedBoostEligibilityTokenMiningIndex) =>
