...
pub trait Trait: system::Trait + roaming_operators::Trait + mining_speed_boosts_configuration_hardware_mining::Trait {
    ...
    type MiningSpeedBoostSamplingHardwareMiningSampleDate: Parameter + Member + SimpleArithmetic + Bounded + Default + Copy;
    type MiningSpeedBoostSamplingHardwareMiningSampleHardwareOnline: Parameter + Member + SimpleArithmetic + Bounded + Default + Copy;
  }
