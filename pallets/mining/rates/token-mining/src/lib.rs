...
decl_storage! {
    trait Store for Module<T: Trait> as MiningSpeedBoostRatesTokenMining {
        ...
        pub MiningSpeedBoostRatesTokenMinings get(fn mining_rates_token_mining): map hasher(opaque_blake2_256) T::MiningSpeedBoostRatesTokenMiningIndex => Option<MiningSpeedBoostRatesTokenMining>;

        /// Stores the total number of mining_rates_token_minings. i.e. the next mining_rates_token_mining index
        pub MiningSpeedBoostRatesTokenMiningCount get(fn mining_rates_token_mining_count): T::MiningSpeedBoostRatesTokenMiningIndex;

        /// Stores mining_rates_token_mining owner
        pub MiningSpeedBoostRatesTokenMiningOwners get(fn mining_rates_token_mining_owner): map hasher(opaque_blake2_256) T::MiningSpeedBoostRatesTokenMiningIndex => Option<T::AccountId>;

        /// Stores mining_rates_token_mining_rates_config
        pub MiningSpeedBoostRatesTokenMiningRatesConfigs get(fn mining_rates_token_mining_rates_configs): map hasher(opaque_blake2_256) T::MiningSpeedBoostRatesTokenMiningIndex =>
...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn create(origin) {
            ...
            let mining_rates_token_mining = MiningSpeedBoostRatesTokenMining(unique_id);
        ...
        #[weight = 10_000 + T::DbWeight::get().writes(1)]
        pub fn transfer(origin, to: T::AccountId, mining_rates_token_mining_id: T::MiningSpeedBoostRatesTokenMiningIndex) {
            let sender = ensure_signed(origin)?;
        ...
        pub fn set_mining_rates_token_mining_rates_config(
            origin,
            mining_rates_token_mining_id: T::MiningSpeedBoostRatesTokenMiningIndex,
            ...
            ensure!(is_mining_rates_token_mining, "MiningSpeedBoostRatesTokenMining does not exist");
            ...
            if Self::has_value_for_mining_rates_token_mining_rates_config_index(mining_rates_token_mining_id).is_ok() {
                ...
                <MiningSpeedBoostRatesTokenMiningRatesConfigs<T>>::mutate(mining_rates_token_mining_id, |mining_rates_token_mining_rates_config| {
                ...
                let fetched_mining_rates_token_mining_rates_config = <MiningSpeedBoostRatesTokenMiningRatesConfigs<T>>::get(mining_rates_token_mining_id);
                ...
                let mining_rates_token_mining_rates_config_instance = MiningSpeedBoostRatesTokenMiningRatesConfig {
...
impl<T: Trait> Module<T> {
    ...
    pub fn has_value_for_mining_rates_token_mining_rates_config_index(
        ...
        let fetched_mining_rates_token_mining_rates_config =
            <MiningSpeedBoostRatesTokenMiningRatesConfigs<T>>::get(mining_rates_token_mining_id);
    ...
    fn insert_mining_rates_token_mining(
        owner: &T::AccountId,
        mining_rates_token_mining_id: T::MiningSpeedBoostRatesTokenMiningIndex,
        mining_rates_token_mining: MiningSpeedBoostRatesTokenMining,
    ) {
        ...
        <MiningSpeedBoostRatesTokenMiningCount<T>>::put(mining_rates_token_mining_id + One::one());
        <MiningSpeedBoostRatesTokenMiningOwners<T>>::insert(mining_rates_token_mining_id, owner.clone());
    }
    ...
    fn update_owner(
        ...
        <MiningSpeedBoostRatesTokenMiningOwners<T>>::insert(mining_rates_token_mining_id, to);
    }
}
