...
pub struct MiningSamplingTokenSamplingConfig<U, V> {
...
decl_event!(
        ...
        // Balance = BalanceOf<T>,
    {
        ...
        MiningSamplingTokenSamplingConfigSet(
...
decl_storage! {
    trait Store for Module<T: Trait> as MiningSamplingToken {
        ...
        pub MiningSamplingTokenSamplingConfigs get(fn mining_samplings_token_samplings_configs): map hasher(opaque_blake2_256) (T::MiningConfigTokenIndex, T::MiningSamplingTokenIndex) =>
            Option<MiningSamplingTokenSamplingConfig<
                T::BlockNumber,
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn set_mining_samplings_token_samplings_config(
            ...
            if Self::has_value_for_mining_samplings_token_samplings_config_index(mining_config_token_id, mining_samplings_token_id).is_ok() {
                ...
                <MiningSamplingTokenSamplingConfigs<T>>::mutate((mining_config_token_id, mining_samplings_token_id), |mining_samplings_token_samplings_config| {
                ...
                let fetched_mining_samplings_token_samplings_config = <MiningSamplingTokenSamplingConfigs<T>>::get((mining_config_token_id, mining_samplings_token_id));
                ...
                let mining_samplings_token_samplings_config_instance = MiningSamplingTokenSamplingConfig {
                ...
                <MiningSamplingTokenSamplingConfigs<T>>::insert(
            ...
            Self::deposit_event(RawEvent::MiningSamplingTokenSamplingConfigSet(
                sender,
...
impl<T: Trait> Module<T> {
    ...
    pub fn exists_mining_samplings_token_samplings_config(
        ...
        match Self::mining_samplings_token_samplings_configs((
            ...
            Some(_value) => Ok(()),
            None => Err(DispatchError::Other("MiningSamplingTokenSamplingConfig does not exist")),
        }
    }
    ...
    pub fn has_value_for_mining_samplings_token_samplings_config_index(
        ...
        let fetched_mining_samplings_token_samplings_config =
            <MiningSamplingTokenSamplingConfigs<T>>::get((
                mining_config_token_id,
                mining_samplings_token_id,
            ));
