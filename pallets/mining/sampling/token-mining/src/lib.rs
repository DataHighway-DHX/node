...
pub trait Trait:
    frame_system::Trait + roaming_operators::Trait + mining_configuration_token_mining::Trait
{
...
decl_event!(
        ...
        // Balance = BalanceOf<T>,
    {
        ...
        /// (owner of mining_token_mining, mining_samplings_token_mining_id, mining_configuration_token_mining_id)
...
decl_storage! {
    trait Store for Module<T: Trait> as MiningSpeedBoostSamplingTokenMining {
        ...
        pub MiningSpeedBoostSamplingTokenMinings get(fn mining_samplings_token_mining): map hasher(opaque_blake2_256) T::MiningSpeedBoostSamplingTokenMiningIndex => Option<MiningSpeedBoostSamplingTokenMining>;

        /// Stores the total number of mining_samplings_token_minings. i.e. the next mining_samplings_token_mining index
        pub MiningSpeedBoostSamplingTokenMiningCount get(fn mining_samplings_token_mining_count): T::MiningSpeedBoostSamplingTokenMiningIndex;

        /// Stores mining_samplings_token_mining owner
        pub MiningSpeedBoostSamplingTokenMiningOwners get(fn mining_samplings_token_mining_owner): map hasher(opaque_blake2_256) T::MiningSpeedBoostSamplingTokenMiningIndex => Option<T::AccountId>;

        /// Stores mining_samplings_token_mining_samplings_config
        pub MiningSpeedBoostSamplingTokenMiningSamplingConfigs get(fn mining_samplings_token_mining_samplings_configs): map hasher(opaque_blake2_256) (T::MiningSpeedBoostConfigurationTokenMiningIndex, T::MiningSpeedBoostSamplingTokenMiningIndex) =>
            Option<MiningSpeedBoostSamplingTokenMiningSamplingConfig<
                T::BlockNumber,
                T::MiningSpeedBoostSamplingTokenMiningSampleLockedAmount
            >>;

        /// Get mining_configuration_token_mining_id belonging to a mining_samplings_token_mining_id
        ...
        /// Get mining_samplings_token_mining_id's belonging to a mining_configuration_token_mining_id
...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn create(origin) {
            ...
            let mining_samplings_token_mining = MiningSpeedBoostSamplingTokenMining(unique_id);
        ...
        #[weight = 10_000 + T::DbWeight::get().writes(1)]
        pub fn transfer(origin, to: T::AccountId, mining_samplings_token_mining_id: T::MiningSpeedBoostSamplingTokenMiningIndex) {
            let sender = ensure_signed(origin)?;
        ...
        pub fn set_mining_samplings_token_mining_samplings_config(
            ...
            mining_samplings_token_mining_id: T::MiningSpeedBoostSamplingTokenMiningIndex,
            ...
            ensure!(is_mining_samplings_token_mining, "MiningSpeedBoostSamplingTokenMining does not exist");
            ...
            if Self::has_value_for_mining_samplings_token_mining_samplings_config_index(mining_configuration_token_mining_id, mining_samplings_token_mining_id).is_ok() {
                debug::info!("Mutating values");
                <MiningSpeedBoostSamplingTokenMiningSamplingConfigs<T>>::mutate((mining_configuration_token_mining_id, mining_samplings_token_mining_id), |mining_samplings_token_mining_samplings_config| {
                ...
                let fetched_mining_samplings_token_mining_samplings_config = <MiningSpeedBoostSamplingTokenMiningSamplingConfigs<T>>::get((mining_configuration_token_mining_id, mining_samplings_token_mining_id));
                ...
                let mining_samplings_token_mining_samplings_config_instance = MiningSpeedBoostSamplingTokenMiningSamplingConfig {
                ...
                <MiningSpeedBoostSamplingTokenMiningSamplingConfigs<T>>::insert(
                    (mining_configuration_token_mining_id, mining_samplings_token_mining_id),
        ...
        pub fn assign_sampling_to_configuration(
          ...
          mining_configuration_token_mining_id: T::MiningSpeedBoostConfigurationTokenMiningIndex
            ...
            Self::associate_token_sampling_with_configuration(mining_samplings_token_mining_id, mining_configuration_token_mining_id)
            ...
            <TokenMiningSamplingConfiguration<T>>::insert(mining_samplings_token_mining_id, mining_configuration_token_mining_id);

            Self::deposit_event(RawEvent::AssignedTokenMiningSamplingToConfiguration(sender, mining_samplings_token_mining_id, mining_configuration_token_mining_id));
            }
    }
}
...
impl<T: Trait> Module<T> {
    ...
    pub fn associate_token_sampling_with_configuration(
        ...
        if let Some(configuration_samplings) =
            Self::token_mining_configuration_samplings(mining_configuration_token_mining_id)
        {
            debug::info!(
            ...
            <TokenMiningConfigurationSamplings<T>>::mutate(mining_configuration_token_mining_id, |v| {
                if let Some(value) = v {
    ...
    fn insert_mining_samplings_token_mining(
        owner: &T::AccountId,
        mining_samplings_token_mining_id: T::MiningSpeedBoostSamplingTokenMiningIndex,
        mining_samplings_token_mining: MiningSpeedBoostSamplingTokenMining,
    ) {
        ...
        <MiningSpeedBoostSamplingTokenMiningCount<T>>::put(mining_samplings_token_mining_id + One::one());
    ...
    fn update_owner(
        ...
        <MiningSpeedBoostSamplingTokenMiningOwners<T>>::insert(mining_samplings_token_mining_id, to);
    }
}
