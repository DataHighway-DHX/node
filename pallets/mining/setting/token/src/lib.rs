    ...
    pub struct Module<T: Config> for enum Call where origin: T::Origin {
        ...
        pub fn set_mining_setting_token_token_setting(
            ...
            if Self::has_value_for_mining_setting_token_token_setting_index(mining_setting_token_id).is_ok() {
                ...
                if let Some(_mining_setting_token_token_setting) = fetched_mining_setting_token_token_setting {
                    log::info!("Latest field token_type {:#?}", _mining_setting_token_token_setting.token_type);
                    log::info!("Latest field token_lock_amount {:#?}", _mining_setting_token_token_setting.token_lock_amount);
                    log::info!("Latest field token_lock_start_block {:#?}", _mining_setting_token_token_setting.token_lock_start_block);
                    log::info!("Latest field token_lock_interval_blocks {:#?}", _mining_setting_token_token_setting.token_lock_interval_blocks);
                }
            } else {
                ...
                let fetched_mining_setting_token_token_setting = <MiningSettingTokenSettings<T>>::get(mining_setting_token_id);
                if let Some(_mining_setting_token_token_setting) = fetched_mining_setting_token_token_setting {
                    log::info!("Inserted field token_type {:#?}", _mining_setting_token_token_setting.token_type);
                    log::info!("Inserted field token_lock_amount {:#?}", _mining_setting_token_token_setting.token_lock_amount);
                    log::info!("Inserted field token_lock_start_block {:#?}", _mining_setting_token_token_setting.token_lock_start_block);
                    log::info!("Inserted field token_lock_interval_blocks {:#?}", _mining_setting_token_token_setting.token_lock_interval_blocks);
                }
            }
        ...
        pub fn set_mining_setting_token_token_cooldown_config(
            ...
            if Self::has_value_for_mining_setting_token_token_cooldown_config_index(mining_setting_token_id).is_ok() {
                ...
                if let Some(_mining_setting_token_token_cooldown_config) = fetched_mining_setting_token_token_cooldown_config {
                    log::info!("Latest field token_type {:#?}", _mining_setting_token_token_cooldown_config.token_type);
                    log::info!("Latest field token_lock_min_amount {:#?}", _mining_setting_token_token_cooldown_config.token_lock_min_amount);
                    log::info!("Latest field token_lock_min_blocks {:#?}", _mining_setting_token_token_cooldown_config.token_lock_min_blocks);
                }
            } else {
                log::info!("Inserting values");
                ...
                let fetched_mining_setting_token_token_cooldown_config = <MiningSettingTokenRequirementsSettings<T>>::get(mining_setting_token_id);
                if let Some(_mining_setting_token_token_cooldown_config) = fetched_mining_setting_token_token_cooldown_config {
                    log::info!("Inserted field token_type {:#?}", _mining_setting_token_token_cooldown_config.token_type);
                    log::info!("Inserted field token_lock_min_amount {:#?}", _mining_setting_token_token_cooldown_config.token_lock_min_amount);
                    log::info!("Inserted field token_lock_min_blocks {:#?}", _mining_setting_token_token_cooldown_config.token_lock_min_blocks);
                }
            }
...
impl<T: Config> Module<T> {
    ...
    pub fn has_value_for_mining_setting_token_token_setting_index(
        ...
        log::info!("Checking if mining_setting_token_token_setting has a value that is defined");
        let fetched_mining_setting_token_token_setting = <MiningSettingTokenSettings<T>>::get(mining_setting_token_id);
        if let Some(_value) = fetched_mining_setting_token_token_setting {
            log::info!("Found value for mining_setting_token_token_setting");
            return Ok(());
        }
        log::info!("No value for mining_setting_token_token_setting");
    ...
    pub fn has_value_for_mining_setting_token_token_cooldown_config_index(
        ...
        log::info!("Checking if mining_setting_token_token_cooldown_config has a value that is defined");
        ...
        if let Some(_value) = fetched_mining_setting_token_token_cooldown_config {
            log::info!("Found value for mining_setting_token_token_cooldown_config");
            return Ok(());
        }
        log::info!("No value for mining_setting_token_token_cooldown_config");
