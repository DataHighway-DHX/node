...
decl_module! {
    ...
    pub struct Module<T: Config> for enum Call where origin: T::Origin {
        ...
        //               log::info!("Calculate eligibilty based on average {:#?}", token_calculated_eligibility);
        //             }
        //           }
        //         }
        //       }
        ...
        //             log::info!("Latest field token_calculated_eligibility {:#?}", _mining_eligibility_token_result.token_calculated_eligibility);
        //             log::info!("Latest field token_locked_percentage {:#?}", _mining_eligibility_token_result.token_locked_percentage);
        //             // log::info!("Latest field token_block_audited {:#?}", _mining_eligibility_token_result.token_block_audited);
        //             // log::info!("Latest field token_auditor_account_id {:#?}", _mining_eligibility_token_result.token_auditor_account_id);
        //         }
        //     } else {
        ...
        //         let fetched_mining_eligibility_token_result = <MiningEligibilityTokenResults<T>>::get((mining_setting_token_id, mining_eligibility_token_id));
        //         if let Some(_mining_eligibility_token_result) = fetched_mining_eligibility_token_result {
        //             log::info!("Inserted field token_calculated_eligibility {:#?}", _mining_eligibility_token_result.token_calculated_eligibility);
        //             log::info!("Inserted field token_locked_percentage {:#?}", _mining_eligibility_token_result.token_locked_percentage);
        //             // log::info!("Inserted field token_block_audited {:#?}", _mining_eligibility_token_result.token_block_audited);
        //             // log::info!("Inserted field token_auditor_account_id {:#?}", _mining_eligibility_token_result.token_auditor_account_id);
        //         }
        //     }
...
impl<T: Config> Module<T> {
    ...
    pub fn has_value_for_mining_eligibility_token_result_index(
        ...
        log::info!("Checking if mining_eligibility_token_result has a value that is defined");
        ...
        if let Some(_value) = fetched_mining_eligibility_token_result {
            log::info!("Found value for mining_eligibility_token_result");
            return Ok(());
        }
        log::info!("No value for mining_eligibility_token_result");
