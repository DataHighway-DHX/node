...
pub trait Config:
    ...
    + mining_speed_boosts_eligibility_token_mining::Config
...
decl_event!(
    pub enum Event<T> where
        ...
        <T as Config>::MiningSpeedBoostLodgementsTokenMiningIndex,
        <T as Config>::MiningSpeedBoostLodgementsTokenMiningLodgementAmount,
        <T as Config>::MiningSpeedBoostLodgementsTokenMiningLodgementDateRedeemed,
...
decl_storage! {
    trait Store for Module<T: Config> as MiningSpeedBoostLodgementsTokenMining {
