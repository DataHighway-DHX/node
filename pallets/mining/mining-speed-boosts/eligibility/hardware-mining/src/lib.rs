...
pub trait Trait: system::Trait +
    ...
    mining_speed_boosts_sampling_hardware_mining::Trait
  {
    ...
    type MiningSpeedBoostEligibilityHardwareMiningCalculatedEligibility: Parameter + Member + AtLeast32Bit + Bounded + Default + Copy;
    type MiningSpeedBoostEligibilityHardwareMiningHardwareUptimePercentage: Parameter + Member + AtLeast32Bit + Bounded + Default + Copy;
    // type MiningSpeedBoostEligibilityHardwareMiningDateAudited: Parameter + Member + AtLeast32Bit + Bounded + Default + Copy;
    // type MiningSpeedBoostEligibilityHardwareMiningAuditorAccountID: Parameter + Member + AtLeast32Bit + Bounded + Default + Copy;
  }
...
impl<T: Trait> Module<T> {
	pub fn is_mining_speed_boosts_eligibility_hardware_mining_owner(mining_speed_boosts_eligibility_hardware_mining_id: T::MiningSpeedBoostEligibilityHardwareMiningIndex, sender: T::AccountId) -> Result<(), DispatchError> {
        ensure!(
    ...
    pub fn exists_mining_speed_boosts_eligibility_hardware_mining(mining_speed_boosts_eligibility_hardware_mining_id: T::MiningSpeedBoostEligibilityHardwareMiningIndex) -> Result<MiningSpeedBoostEligibilityHardwareMining, DispatchError> {
    ...
    pub fn exists_mining_speed_boosts_eligibility_hardware_mining_result(
        ...
        match Self::mining_speed_boosts_eligibility_hardware_mining_eligibility_results(
          (mining_speed_boosts_configuration_hardware_mining_id, mining_speed_boosts_eligibility_hardware_mining_id)
            ...
            Some(value) => Ok(()),
            None => Err(DispatchError::Other("MiningSpeedBoostEligibilityHardwareMiningEligibilityResult does not exist"))
        }
    }
    ...
    fn next_mining_speed_boosts_eligibility_hardware_mining_id() -> Result<T::MiningSpeedBoostEligibilityHardwareMiningIndex, DispatchError> {
