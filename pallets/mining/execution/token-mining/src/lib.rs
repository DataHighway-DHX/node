...
pub trait Trait:
    ...
    + mining_claims_token_mining::Trait
{
    type Event: From<Event<Self>> + Into<<Self as frame_system::Trait>::Event>;
    type MiningExecutionTokenMiningIndex: Parameter + Member + AtLeast32Bit + Bounded + Default + Copy;
    // type MiningExecutionTokenMiningExecutorAccountID: Parameter
    //     + Member
    //     + AtLeast32Bit
    //     + Bounded
    //     + Default
...
pub struct MiningExecutionTokenMining(pub [u8; 16]);

#[cfg_attr(feature = "std", derive(Debug))]
#[derive(Encode, Decode, Default, Clone, PartialEq)]
pub struct MiningExecutionTokenMiningExecutionResult<U, V, W> {
...
decl_event!(
    pub enum Event<T> where
        ...
        <T as Trait>::MiningExecutionTokenMiningIndex,
        // <T as Trait>::MiningExecutionTokenMiningExecutorAccountID,
        ...
        // Balance = BalanceOf<T>,
    {
        ...
        Created(AccountId, MiningExecutionTokenMiningIndex),
        /// A mining_execution_token_mining is transferred. (from, to, mining_execution_token_mining_id)
        Transferred(AccountId, AccountId, MiningExecutionTokenMiningIndex),
        MiningExecutionTokenMiningExecutionResultSet(
            AccountId, MiningConfigTokenMiningIndex, MiningExecutionTokenMiningIndex,
            AccountId, BlockNumber, BlockNumber
        ),
        /// A mining_execution_token_mining is assigned to an mining_token_mining.
        /// (owner of mining_token_mining, mining_execution_token_mining_id, mining_config_token_mining_id)
        AssignedTokenMiningExecutionToConfiguration(AccountId, MiningExecutionTokenMiningIndex, MiningConfigTokenMiningIndex),
    }
);

// This module's storage items.
decl_storage! {
    trait Store for Module<T: Trait> as MiningExecutionTokenMining {
        /// Stores all the mining_execution_token_minings, key is the mining_execution_token_mining id / index
        pub MiningExecutionTokenMinings get(fn mining_execution_token_mining): map hasher(opaque_blake2_256) T::MiningExecutionTokenMiningIndex => Option<MiningExecutionTokenMining>;

        /// Stores the total number of mining_execution_token_minings. i.e. the next mining_execution_token_mining index
        pub MiningExecutionTokenMiningCount get(fn mining_execution_token_mining_count): T::MiningExecutionTokenMiningIndex;

        /// Stores mining_execution_token_mining owner
        pub MiningExecutionTokenMiningOwners get(fn mining_execution_token_mining_owner): map hasher(opaque_blake2_256) T::MiningExecutionTokenMiningIndex => Option<T::AccountId>;

        /// Stores mining_execution_token_mining_execution_result
        pub MiningExecutionTokenMiningExecutionResults get(fn mining_execution_token_mining_execution_results): map hasher(opaque_blake2_256) (T::MiningConfigTokenMiningIndex, T::MiningExecutionTokenMiningIndex) =>
            Option<MiningExecutionTokenMiningExecutionResult<
                T::AccountId,
                T::BlockNumber,
                T::BlockNumber
            >>;

        /// Get mining_config_token_mining_id belonging to a mining_execution_token_mining_id
        pub TokenMiningExecutionConfiguration get(fn token_mining_execution_configuration): map hasher(opaque_blake2_256) T::MiningExecutionTokenMiningIndex => Option<T::MiningConfigTokenMiningIndex>;

        /// Get mining_execution_token_mining_id's belonging to a mining_config_token_mining_id
        pub TokenMiningConfigExecution get(fn token_mining_config_execution): map hasher(opaque_blake2_256) T::MiningConfigTokenMiningIndex => Option<Vec<T::MiningExecutionTokenMiningIndex>>
    }
}
...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn create(origin) {
            ...
            let mining_execution_token_mining = MiningExecutionTokenMining(unique_id);
        ...
        #[weight = 10_000 + T::DbWeight::get().writes(1)]
        pub fn transfer(origin, to: T::AccountId, mining_execution_token_mining_id: T::MiningExecutionTokenMiningIndex) {
            let sender = ensure_signed(origin)?;
        ...
        pub fn set_mining_execution_token_mining_execution_result(
            ...
            mining_execution_token_mining_id: T::MiningExecutionTokenMiningIndex,
            ...
            ensure!(is_mining_execution_token_mining, "MiningExecutionTokenMining does not exist");
            ...
            // let is_token_execution_started_block_greater_than_current_block = Self::token_execution_started_block_greater_than_current_block(mining_execution_token_mining_id, mining_config_token_mining_id).is_ok();
            ...
            // let is_token_lock_interval_blocks_greater_than_token_lock_min_blocks = Self::token_lock_interval_blocks_greater_than_token_lock_min_blocks(mining_execution_token_mining_id, mining_config_token_mining_id).is_ok();
            ...
            let is_token_lock_amount_greater_than_token_lock_min_amount = Self::token_lock_amount_greater_than_token_lock_min_amount(mining_execution_token_mining_id, mining_config_token_mining_id).is_ok();
            ...
            if Self::has_value_for_mining_execution_token_mining_execution_result_index(mining_config_token_mining_id, mining_execution_token_mining_id).is_ok() {
                debug::info!("Mutating values");
                <MiningExecutionTokenMiningExecutionResults<T>>::mutate((mining_config_token_mining_id, mining_execution_token_mining_id), |mining_execution_token_mining_execution_result| {
                ...
                let fetched_mining_execution_token_mining_execution_result = <MiningExecutionTokenMiningExecutionResults<T>>::get((mining_config_token_mining_id, mining_execution_token_mining_id));
                ...
                let mining_execution_token_mining_execution_result_instance = MiningExecutionTokenMiningExecutionResult {
                ...
                <MiningExecutionTokenMiningExecutionResults<T>>::insert(
                    (mining_config_token_mining_id, mining_execution_token_mining_id),
            ...
            Self::deposit_event(RawEvent::MiningExecutionTokenMiningExecutionResultSet(
                sender.clone(),
        ...
        pub fn assign_execution_to_configuration(
          ...
          mining_config_token_mining_id: T::MiningConfigTokenMiningIndex
            ...
            Self::associate_token_execution_with_configuration(mining_execution_token_mining_id, mining_config_token_mining_id)
            ...
            <TokenMiningExecutionConfiguration<T>>::insert(mining_execution_token_mining_id, mining_config_token_mining_id);

            Self::deposit_event(RawEvent::AssignedTokenMiningExecutionToConfiguration(sender, mining_execution_token_mining_id, mining_config_token_mining_id));
            }
    }
}
...
impl<T: Trait> Module<T> {
    pub fn is_mining_execution_token_mining_owner(
        ...
        sender: T::AccountId,
            ...
            Self::mining_execution_token_mining_owner(&mining_execution_token_mining_id)
                ...
                .unwrap_or(false),
            "Sender is not owner of MiningExecutionTokenMining"
        );
        Ok(())
    }
    ...
    pub fn exists_mining_execution_token_mining(
        mining_execution_token_mining_id: T::MiningExecutionTokenMiningIndex,
    ) -> Result<MiningExecutionTokenMining, DispatchError> {
        match Self::mining_execution_token_mining(mining_execution_token_mining_id) {
            Some(value) => Ok(value),
            None => Err(DispatchError::Other("MiningExecutionTokenMining does not exist")),
        }
    }
    ...
    pub fn exists_mining_execution_token_mining_execution_result(
        ...
        match Self::mining_execution_token_mining_execution_results((
            ...
            Some(_value) => Ok(()),
            None => Err(DispatchError::Other("MiningExecutionTokenMiningExecutionResult does not exist")),
        }
    }
    ...
    pub fn token_lock_interval_blocks_greater_than_token_lock_min_blocks(
        ...
        if let Some(configuration_token_mining) = <mining_config_token_mining::Module<T>>::mining_config_token_mining_token_configs((mining_config_token_mining_id)) {
            if let Some(cooldown_configuration_token_mining) = <mining_config_token_mining::Module<T>>::mining_config_token_mining_token_cooldown_configs((mining_config_token_mining_id)) {
    ...
    pub fn has_value_for_mining_execution_token_mining_execution_result_index(
        ...
        let fetched_mining_execution_token_mining_execution_result =
            <MiningExecutionTokenMiningExecutionResults<T>>::get((
                mining_config_token_mining_id,
                mining_execution_token_mining_id,
            ));
    ...
    pub fn associate_token_execution_with_configuration(
        ...
        if let Some(configuration_execution) =
            Self::token_mining_config_execution(mining_config_token_mining_id)
        {
            debug::info!(
            ...
            <TokenMiningConfigExecution<T>>::mutate(mining_config_token_mining_id, |v| {
                if let Some(value) = v {
            ...
            <TokenMiningConfigExecution<T>>::insert(
                mining_config_token_mining_id,
    ...
    -> Result<T::MiningExecutionTokenMiningIndex, DispatchError> {
        let mining_execution_token_mining_id = Self::mining_execution_token_mining_count();
        if mining_execution_token_mining_id ==
            <T::MiningExecutionTokenMiningIndex as Bounded>::max_value()
        {
            return Err(DispatchError::Other("MiningExecutionTokenMining count overflow"));
        }
    ...
    fn insert_mining_execution_token_mining(
        owner: &T::AccountId,
        mining_execution_token_mining_id: T::MiningExecutionTokenMiningIndex,
        mining_execution_token_mining: MiningExecutionTokenMining,
    ) {
        // Create and store mining mining_execution_token_mining
        <MiningExecutionTokenMinings<T>>::insert(
            mining_execution_token_mining_id,
            mining_execution_token_mining,
        );
        <MiningExecutionTokenMiningCount<T>>::put(mining_execution_token_mining_id + One::one());
        <MiningExecutionTokenMiningOwners<T>>::insert(
            mining_execution_token_mining_id,
            owner.clone(),
        );
    }
    ...
    fn update_owner(
        ...
        <MiningExecutionTokenMiningOwners<T>>::insert(mining_execution_token_mining_id, to);
    }
}
