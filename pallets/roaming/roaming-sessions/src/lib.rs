...
decl_event!(
    pub enum Event<T> where
        ...
        <T as Config>::RoamingSessionJoinRequestRequestedAt,
        <T as Config>::RoamingSessionJoinRequestAcceptExpiry,
        <T as Config>::RoamingSessionJoinRequestAcceptAcceptedAt,
